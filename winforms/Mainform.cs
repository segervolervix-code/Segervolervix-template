    ...
    public partial class MainForm : Form
    {
        ...
        private async void sendButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    await HandleImageGeneration(tool.Payload, model);
                }
                else
                {
                    await HandleChatRequest(text, model, tool);
                }
            }
            catch
            {
        ...
        private async System.Threading.Tasks.Task HandleChatRequest(string text, string model, ToolCommand tool)
        {
        ...
        private async System.Threading.Tasks.Task HandleImageGeneration(string prompt, string model)
        {
